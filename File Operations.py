...
➡️ Aim:
To write a Python program to display the first N lines of a file and find the
frequency of a specific word in the file.
...
➡️ Result:
Thus the Python program that displays the first N lines and counts the 
frequency of a given word in a file is executed successfully.
